...
- 2026-09-11, sesja session_01YVYBimtiCfF3SS1QHH4Cvi: kontroler przepuścił regex przez 17, a potem 24 kształty wejścia, zanim zapisał go do briefu — najpierw wersję implementera, wykazując, że kasuje granicę akapitu, potem własną. Dispatch był dzięki temu transkrypcją, nie projektowaniem, a recenzent potwierdził te same wyniki niezależnie.
