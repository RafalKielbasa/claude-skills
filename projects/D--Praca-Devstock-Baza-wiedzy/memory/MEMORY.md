...
- [Tryb commitów per repo](tryb-commitow-per-repo.md) — od 2026-09-18 domyślną ustala repo: „Baza wiedzy" commituję sam, repo z kodem tylko na polecenie (`ask`), push nigdzie bez jawnej zgody Rafała.
